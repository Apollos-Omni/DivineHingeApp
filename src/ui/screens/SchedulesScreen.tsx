...
export const SchedulesScreen: React.FC = () => {
  ...
  React.useEffect(() => {
    if (!doorId && firstDoor) setDoorId(firstDoor);
  }, [doorId, firstDoor]);
      ...
      {devices.length === 0 ? (
        ...
        <>
          ...
          <TouchableOpacity
            ...
            onPress={() => addDaily(doorId, action, hhmm)}
          >
            <Text style={styles.primaryTxt}>Add Daily</Text>
          </TouchableOpacity>
          ...
          <TextInput
            value={iso}
            onChangeText={setISO}
            placeholder="2025-09-02T22:00:00.000Z"
            placeholderTextColor="#777"
            style={styles.input}
          />
          ...
          <TouchableOpacity
            ...
            onPress={() => addOnce(doorId, action, iso)}
          >
            <Text style={styles.secondaryTxt}>Add One-Time</Text>
          </TouchableOpacity>
        </>
      )}
