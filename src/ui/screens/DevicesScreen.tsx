  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Manage your doors with divine precision.
      </Text>
      ...
      {devices.length > 0 && (
        <View style={styles.row}>
          ...
          <TouchableOpacity
            style={[styles.actionBtn, { backgroundColor: "#7FFF00" }]}
            onPress={unlockAll}
          >
            <Text style={[styles.actionText, { color: "#121212" }]}>
              Unlock All
            </Text>
          </TouchableOpacity>
        </View>
        ...
        renderItem={({ item }) => (
          <View style={styles.card}>
            ...
            <TouchableOpacity
              style={[
                styles.smallBtn,
                { backgroundColor: item.isLocked ? "#7FFF00" : "#444" },
              ]}
            ...
            >
              <Text
                style={[
                  styles.smallText,
                  { color: item.isLocked ? "#121212" : "#eee" },
                ]}
              >
            ...
            >
              <Text style={[styles.smallText, { color: "#121212" }]}>
                Remove
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.modalCard}>
            ...
            <View style={styles.modalRow}>
              <Pressable
                ...
                onPress={closeRename}
              >
                <Text style={[styles.modalBtnText, styles.modalCancelText]}>
                  Cancel
                </Text>
              </Pressable>
              <Pressable
