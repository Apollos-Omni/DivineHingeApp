...
export const RecordingSettingsScreen: React.FC = () => {
  ...
  const save = () => {
    ...
    if (!isNaN(n)) setRecordingLength(n);
  };
  return (
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        <Text style={styles.label}>Motion timestamps</Text>
        <Switch
          value={motionTimestampsEnabled}
          onValueChange={setMotionEnabled}
        />
      </View>
      <Text style={styles.help}>
        Each motion event is recorded with a timestamp in Activity.
      </Text>
    </View>
  );
};
const styles = StyleSheet.create({
  ...
  saveTxt: { color: "#121212", fontWeight: "900" },
  row: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  },
  help: { color: "#888", marginTop: 6 },
});
