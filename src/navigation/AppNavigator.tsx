...
function AppStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: true }}>
      ...
      <Stack.Screen name="DoorHub" component={DoorHubScreen} options={{ title: 'Door Hub' }} />
      <Stack.Screen name="HingeDetail" component={HingeDetailScreen} options={{ title: 'Hinge' }} />
      <Stack.Screen name="HallwayHome" component={HallwayHomeScreen} options={{ title: 'Hallway' }} />
      <Stack.Screen name="HomeHallway" component={HomeHallway} options={{ title: 'Home Hallway' }} />
      <Stack.Screen name="Activity" component={ActivityScreen} options={{ title: 'Activity' }} />
      <Stack.Screen name="RenameDevice" component={RenameDeviceScreen} options={{ title: 'Rename Device' }} />
      <Stack.Screen name="SuperResponder" component={SuperResponderScreen} options={{ headerShown: true, title: 'Super Responder' }} />
